...
@WebServlet(name = "catMenuController", urlPatterns = {"/catMenu"})
public class CatMenuController extends HttpServlet {
...
//      String dispatchString = "";
        ...
        List<FoodTypes> foodTypes = foodTypeService.findFoodTypesEntities();
        request.setAttribute("foodCategories", foodTypes);
    ...
    private void dispatchRequest(HttpServletRequest request, HttpServletResponse
            response, String dashboardURL) throws ServletException, IOException {
