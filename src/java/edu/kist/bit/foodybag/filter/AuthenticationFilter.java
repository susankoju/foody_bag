 ...
 */
package edu.kist.bit.foodybag.filter;
...
import edu.kist.bit.foodybag.utils.BCrypt;
...
@WebFilter(filterName = "AuthenticationFilter",
        urlPatterns = {"/*"},
        initParams = @WebInitParam(name = "avoid-urls", value = "/login.jsp,"
                + ".css,"
                + ".js,"
                +"/images/,"
                +"/menu,"
...
public class AuthenticationFilter implements Filter {
    ...
    private boolean checkLogin(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        EntityManagerFactory emf = (EntityManagerFactory) req.getServletContext().getAttribute("foodybagemf");
